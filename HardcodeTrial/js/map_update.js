    ...
    //insert the objects in as a card in the html
        htmlString +=   '<div class="meldung_container_style" id="meldung'+x+'">'+
                            ...
                            '<div>'+
                                ...
                                '<p id="kategorie"><b>Kategorie:</b>    <input id="div-kategorie'+x+'"></p>'+
                                '<p id="beschreibung"><b>Beschreibung:</b> <input id="div-beschreibung'+x+'"></p>'+
                                '<p id="status"><b>Status:</b>  <input id="div-status'+x+'"> <button class="div-delete"> Änderung Speichern</button><button class="div-delete">Löschen</button> </p>'+
                                '</text>'+
                                '<br>'+
                            '</div>'+
                        '</div>'
